...
typedef struct {
    ...
    rfalNfcPropCallback
        rfalNfcpPollerTechnologyDetection; /*!< Prorietary NFC Technoly
                                              Detection callback              */
    rfalNfcPropCallback
    ...
    rfalNfcPropCallback
        rfalNfcpPollerGetCollisionResolutionStatus; /*!< Prorietary NFC Get
                                                       ...
                                                       status callback */
    rfalNfcPropCallback rfalNfcpStartActivation;    /*!< Prorietary NFC Start
                                                       Activation callback    */
    rfalNfcPropCallback
...
typedef struct {
    ...
    bool
        p2pNfcaPrio; /*!< NFC-A P2P (true) or ISO14443-4/T4T (false) priority */
