...
#define RFAL_ANALOG_CONFIG_BITRATE_COMMON                                      \
    (0x0000U) /*!< Common settings for all bit rates in Analog Configuration   \
                 ID */
 ...
 * \param[in]  *config: reference to the configuration list of current
 *Configuraiton ID.
 *
 ...
 *Table to be read. \param[out]    more: 0x00 indicates it is last Configuration
 *ID settings; 0x01 indicates more Configuration ID setting(s) are coming.
 * \param[out]    config: configuration id, number of configuration sets and
 *register-mask-value sets \param[in]     numConfig: the remaining configuration
 *settings space available;
 *
 * \return ERR_NOMEM : if number of Configuration for respective Configuration
 *ID is greater the the remaining configuration setting space available \return
