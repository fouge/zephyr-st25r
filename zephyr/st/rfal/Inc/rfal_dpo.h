 ...
 */
void
rfalDpoSetMeasureCallback(rfalDpoMeasureFunc dpoMeasureFunc);
 ...
 * \param[in]    tblBufEntries: number of entries available in tblBuf to place
 *the power Table \param[out]   tableEntries: returned number of entries
