...
typedef struct {
    ...
    uint8_t FsciProType; /*!< Frame Size Card Integer [4b] | Protocol Type[4
                            bits]                           */
 ...
 * \return ERR_PAR          : Parity error detected, one or more device in the
 *field \return ERR_CRC          : CRC error detected, one or more device in the
 *field \return ERR_FRAMING      : Framing error detected, one or more device in
 *the field \return ERR_PROTO        : Protocol error detected, invalid
 *SENSB_RES received \return ERR_NONE         : No error, SENSB_RES received
 *****************************************************************************
 */
ReturnCode
 ...
 */
ReturnCode
rfalNfcbPollerStartSlottedCollisionResolution(
