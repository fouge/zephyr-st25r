...
#define RFAL_NFCA_SENS_RES_PLATFORM_MASK                                       \
    0x0FU /*!< SENS_RES (ATQA) platform configuration mask  Digital 1.1 Table  \
             10 */
#define RFAL_NFCA_SENS_RES_PLATFORM_T1T                                        \
    0x0CU /*!< SENS_RES (ATQA) T1T platform configuration  Digital 1.1 Table   \
             10  */
...
#define RFAL_NFCA_SEL_RES_CONF_T4T_NFCDEP                                      \
    0x60U /*!< SEL_RES (SAK) T4T and NFC-DEP configuration  Digital 1.1 Table  \
             19 */
 ...
 *the field \return ERR_PROTO        : Protocol error detected, one or more
 *device in the field \return ERR_TIMEOUT      : Timeout error, no listener
 *device detected \return ERR_NONE         : No error, one or more device in the
 *field
 *****************************************************************************
 */
ReturnCode
