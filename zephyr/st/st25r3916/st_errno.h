...
#define ERR_INVALID_HANDLE                                                     \
    ((ReturnCode)38U) /*!< invalid or not initalized device handle */

#define ERR_INCOMPLETE_BYTE                                                    \
    ((ReturnCode)40U) /*!< Incomplete byte rcvd         */
#define ERR_INCOMPLETE_BYTE_01                                                 \
    ((ReturnCode)41U) /*!< Incomplete byte rcvd - 1 bit */
#define ERR_INCOMPLETE_BYTE_02                                                 \
    ((ReturnCode)42U) /*!< Incomplete byte rcvd - 2 bit */
#define ERR_INCOMPLETE_BYTE_03                                                 \
    ((ReturnCode)43U) /*!< Incomplete byte rcvd - 3 bit */
#define ERR_INCOMPLETE_BYTE_04                                                 \
    ((ReturnCode)44U) /*!< Incomplete byte rcvd - 4 bit */
#define ERR_INCOMPLETE_BYTE_05                                                 \
    ((ReturnCode)45U) /*!< Incomplete byte rcvd - 5 bit */
#define ERR_INCOMPLETE_BYTE_06                                                 \
    ((ReturnCode)46U) /*!< Incomplete byte rcvd - 6 bit */
#define ERR_INCOMPLETE_BYTE_07                                                 \
...
#define ERR_WARN_GRP                                                           \
    (0x0100) /*!< Errors which are not expected in normal operation */
...
#define ERR_INSERT_PROCESS_GRP(x)                                              \
    (ERR_PROCESS_GRP | (x)) /*!< Insert the process grp */
#define ERR_INSERT_WARN_GRP(x) (ERR_WARN_GRP | (x)) /*!< Insert the i2c grp */
#define ERR_INSERT_GENERIC_GRP(x)                                              \
    (ERR_GENERIC_GRP | (x)) /*!< Insert the generic grp */
