...
typedef struct {
    ...
    uint8_t RsB[ST25R3916_SPACE_B_REG_LEN]; /*!< Registers contained on
                                               ST25R3916 space B (Rs-B)     */
} t_st25r3916Regs;
...
#define st25r3916IsTxEnabled()                                                 \
    st25r3916CheckReg(ST25R3916_REG_OP_CONTROL,                                \
                      ST25R3916_REG_OP_CONTROL_tx_en,                          \
                      ST25R3916_REG_OP_CONTROL_tx_en)
 ...
 *  \return ERR_IO           : Error during communication selftest. Check
 *communication interface \return ERR_TIMEOUT      : Timeout during IRQ
 *selftest. Check IRQ handling \return ERR_SYSTEM       : Failure during
 *oscillator activation or timer error
 *
 *****************************************************************************
 */
ReturnCode
 ...
 *  \return ERR_NONE   : No error, Oscillator is active and stable, Regulator is
 *on
 *
 *****************************************************************************
 */
