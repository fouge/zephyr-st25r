...
#define ST25R3916_IRQ_MASK_DCT                                                 \
    (uint32_t)(0x00008000U) /*!< ST25R3916 termination of direct command       \
                               interrupt.          */
#define ST25R3916_IRQ_MASK_NRE                                                 \
    (uint32_t)(                                                                \
        0x00004000U) /*!< ST25R3916 no-response timer expired interrupt */
...
#define ST25R3916_IRQ_MASK_CAT                                                 \
    (uint32_t)(                                                                \
        0x00000200U) /*!< ST25R3916 minimum guard time expired interrupt */
...
#define ST25R3916_IRQ_MASK_APON                                                \
    (uint32_t)(0x20000000U) /*!< ST25R3916 Anticollision done and Field On     \
                               interrupt         */
#define ST25R3916_IRQ_MASK_RXE_PTA                                             \
    (uint32_t)(0x10000000U) /*!< ST25R3916 RXE with an automatic response      \
                               interrupt          */
#define ST25R3916_IRQ_MASK_WU_F                                                \
    (uint32_t)(0x08000000U) /*!< ST25R3916 212/424b/s Passive target           \
                               interrupt: Active       */
 ...
 */
uint32_t
st25r3916WaitForInterruptsTimed(uint32_t mask, uint16_t tmo);
 ...
 */
uint32_t
st25r3916GetInterrupt(uint32_t mask);
 ...
 */
void
st25r3916ModifyInterrupts(uint32_t clr_mask, uint32_t set_mask);
 ...
 */
void
st25r3916CheckForReceivedInterrupts(void);
 ...
 */
void
st25r3916EnableInterrupts(uint32_t mask);
 ...
 */
void
st25r3916DisableInterrupts(uint32_t mask);
 ...
 */
void
st25r3916ClearAndEnableInterrupts(uint32_t mask);
 ...
 */
void
st25r3916IRQCallbackSet(void (*cb)(void));
 ...
 */
void
st25r3916IRQCallbackRestore(void);
